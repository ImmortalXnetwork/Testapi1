...
const BASE_URL = 'https://gogoanime.org.za/';
const BASE_URL2 = 'https://gogoanime.org.za/';
const ajax_url = 'https://ajax.gogocdn.net/';
const anime_info_url = 'https://gogoanime.org.za/category/';
...
const seasons_url = 'https://gogoanime.org.za/sub-category/';

const Referer = 'https://gogoanime.org.za/';
const goload_stream_url = 'https://gogoanime.org.za/streaming.php';
export const DownloadReferer = 'https://gogoanime.org.za/';
...
export const scrapeAnimeDetails = async ({ id }) => {
  try {
    ...
    const animePageTest = await axios.get(`https://ww3.gogoanimes.fi/category/${id}`);
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const WatchAnime = await axios.get(`https://ww3.gogoanimes.fi/${id}`);
